...
type CarrierEvent struct {
	...
	CarrierKey     uint32                   `protobuf:"varint,3,opt,name=carrier_key,json=carrierKey,proto3" json:"carrier_key,omitempty"`
	...
	SendTimestamp  int64                    `protobuf:"varint,5,opt,name=send_timestamp,json=sendTimestamp,proto3" json:"send_timestamp,omitempty"`
	BitEvents      []*CarrierEvent_BitEvent `protobuf:"bytes,6,rep,name=bit_events,json=bitEvents,proto3" json:"bit_events,omitempty"`
}
...
var file_cwcpb_proto_rawDesc = []byte{
	...
	0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x63, 0x61, 0x72, 0x72,
	...
	0x65, 0x6e, 0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x43, 0x61, 0x72,

...
var versionNo = document.getElementById("ver");
var pageStatus = document.getElementById("status");
var socket = new WebSocket("wss://cwc2pi.local:443/ws");
...
function sendChan() {
    emit("chan:"+chan.innerHTML);
}

function incChan() {
   var value = chan.innerHTML;
   value++;
   chan.innerHTML = value;
   sendChan();
}
